...
<div style="border: 1px solid var(--border-color); border-radius: 8px; padding: 16px; margin: 16px 0;
            box-shadow: 2px 2px 8px rgba(0,0,0,0.1); background-color: var(--bg-color); color: var(--text-color);">

  <h3 style="margin-top: 0;">JOURN 345: Principles and Practice of Strategic Communication</h3>
